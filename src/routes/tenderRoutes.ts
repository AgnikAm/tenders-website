...
import { listActiveTenders, getTenderDetails, listFinishedTenders, getFinishedTenderDetails, addTender, submitOffer } from '../controllers/tenderController';
...
router.post('/tenders/:id/offer', submitOffer);
